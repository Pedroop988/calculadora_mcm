"""Módulo para calcular el Mínimo Común Múltiplo (MCM) y el Máximo Común Divisor (MCD)."""

class CalculadoraMCM:
    """Clase para calcular el Mínimo Común Múltiplo (MCM) y el Máximo Común Divisor (MCD)."""
